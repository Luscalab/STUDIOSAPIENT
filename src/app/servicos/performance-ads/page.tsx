...
export default function PerformanceAdsPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative pt-48 pb-16 md:pt-64 md:pb-24 hero-purple-mesh overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 md:gap-32 items-center mb-32 md:mb-64">
            <div className="space-y-12 md:space-y-16">
              <h2 className="font-headline text-5xl md:text-8xl font-black tracking-tighter mb-8 md:mb-12 text-foreground leading-[0.85]">Tráfego de Intenção</h2>
              ...
              <div className="space-y-10">
                {[
                  ...
                  <div key={i} className="flex gap-10 items-start p-10 md:p-12 rounded-[3.5rem] bg-secondary border border-muted hover:border-primary/20 transition-all shadow-xl group">
            ...
            <div className="bg-[#0c0a1a] rounded-[5rem] p-12 md:p-32 text-center text-white space-y-12 shadow-2xl relative overflow-hidden">
