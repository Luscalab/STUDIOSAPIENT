        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="font-headline text-5xl md:text-8xl font-black text-white tracking-tighter leading-tight mb-8 text-balance">
              Domine as <span className="text-primary italic">Buscas Estratégicas</span>
            </h1>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-40">
            <div className="space-y-12">
              <div>
                <h2 className="font-headline text-4xl md:text-6xl font-black tracking-tighter mb-8 text-white">Tráfego Estratégico</h2>
            ...
            <div className="relative">
              <div className="aspect-square rounded-[4rem] overflow-hidden bg-white/5 backdrop-blur-3xl border border-white/10 p-12 flex flex-col justify-center items-center text-center space-y-8 shadow-2xl">
                <div className="h-24 w-24 rounded-full bg-primary/20 flex items-center justify-center text-primary animate-pulse">
                  <TrendingUp className="h-12 w-12" />
                </div>
                <h3 className="font-headline text-3xl font-black tracking-tighter text-white">Crescimento sobre Controle</h3>
                <p className="text-lg text-white/40 font-medium max-w-xs leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-40">
            <div className="p-12 bg-white/5 backdrop-blur-3xl rounded-[3rem] border border-white/5 space-y-6 hover:border-primary/20 transition-all shadow-2xl">
              <div className="flex items-center gap-4">
                <Smartphone className="h-8 w-8 text-primary" />
                <h3 className="text-2xl font-black tracking-tighter text-white">Ecossistemas Mobile</h3>
              </div>
              ...
              <ul className="space-y-3">
                {["Campanhas Direto ao WhatsApp", "Otimização Google Maps", "Páginas de Alta Velocidade"].map((item, i) => (
                  <li key={i} className="flex items-center gap-3 text-sm font-bold text-white/20">
            ...
            <div className="p-12 bg-white/5 backdrop-blur-3xl rounded-[3rem] border border-white/5 space-y-6 hover:border-primary/20 transition-all shadow-2xl">
              <div className="flex items-center gap-4">
                ...
                <h3 className="text-2xl font-black tracking-tighter text-white">Domínio de Nicho</h3>
              </div>
              <p className="text-white/40 leading-relaxed text-lg">
                Não competimos com o mercado, dominamos o seu nicho. Atingimos apenas quem possui o perfil ideal de cliente.
              </p>
              <ul className="space-y-3">
                {["Públicos de Alta Intenção", "Segmentação Estratégica", "Raio Geográfico de Precisão"].map((item, i) => (
                  <li key={i} className="flex items-center gap-3 text-sm font-bold text-white/20">
                    <CheckCircle2 className="h-4 w-4 text-primary" /> {item}
                  </li>
                ))}
          ...
          <div className="max-w-4xl mx-auto p-12 md:p-24 bg-white/5 backdrop-blur-3xl rounded-[4rem] text-white border border-white/10 text-center space-y-12 relative overflow-hidden shadow-2xl">
            ...
            <p className="text-xl text-white/40 max-w-2xl mx-auto font-medium relative z-10">
