        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="font-headline text-5xl md:text-8xl font-black text-white tracking-tighter leading-tight mb-8 text-balance">
              Redes Sociais como <span className="text-primary italic">Prova de Valor</span>
            </h1>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-40">
            <div className="space-y-12">
              <div>
                <h2 className="font-headline text-4xl md:text-6xl font-black tracking-tighter mb-8 text-white">Narrativas de Conversão</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {[
                  ...
                  <div key={i} className="p-8 rounded-[2.5rem] bg-white/5 backdrop-blur-3xl border border-white/5 hover:border-primary/20 transition-all duration-500 shadow-2xl">
                    ...
                    <p className="text-sm text-white/30 font-medium leading-snug">{item.desc}</p>
                  </div>
                ))}
              </div>
          ...
          <div className="max-w-5xl mx-auto py-24 bg-white/5 backdrop-blur-3xl rounded-[4rem] border border-white/5 p-12 md:p-24 text-center space-y-12 shadow-2xl">
            <h3 className="font-headline text-3xl md:text-5xl font-black tracking-tighter text-white">Resultados Tangíveis</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pt-8">
              <div className="space-y-4">
                ...
                <h4 className="font-bold text-xl text-white">Escrita que Vende</h4>
                <p className="text-sm text-white/30">Textos técnicos simplificados para máxima compreensão e desejo.</p>
              </div>
              <div className="space-y-4">
                <div className="h-16 w-16 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto text-primary">
                  <BarChart className="h-8 w-8" />
                </div>
                <h4 className="font-bold text-xl text-white">Gestão de Dados</h4>
                <p className="text-sm text-white/30">Otimização baseada em performance e comportamento do público.</p>
              </div>
              <div className="space-y-4">
                <div className="h-16 w-16 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto text-primary">
                  <Sparkles className="h-8 w-8" />
                </div>
                <h4 className="font-bold text-xl text-white">Desejo de Marca</h4>
                <p className="text-sm text-white/30">Construção de uma comunidade fiel que valoriza seu conhecimento.</p>
              </div>
            </div>
          </div>
        </div>
