...
import { ArrowRight, Sparkles, Target, BarChart3, Palette, Share2, ChevronDown, Users, Zap } from "lucide-react";
      ...
      <section className="relative pt-32 pb-24 md:pt-48 md:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <h1 className="font-headline text-5xl md:text-8xl font-black text-white tracking-tighter leading-[0.9] mb-12 py-4">
            Redes como <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-white to-primary italic font-medium block">Prova de Valor.</span>
          </h1>
          <p className="text-lg md:text-2xl text-white/50 font-medium max-w-4xl mx-auto leading-relaxed tracking-tight text-balance mb-16">
            Construímos autoridade inquestionável através de curadoria estratégica e conteúdo desenhado para atrair o cliente ideal. <span className="text-white font-bold">Menos seguidores, mais decisores.</span>
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
            ...
            <button onClick={() => document.getElementById('manifesto')?.scrollIntoView({behavior:'smooth'})} className="text-white/30 hover:text-white transition-all text-[9px] font-black uppercase tracking-[0.6em] flex items-center gap-4 group">
              Explorar Narrativa <ChevronDown className="h-4 w-4 animate-bounce group-hover:text-primary" />
            </button>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto space-y-16">
            <h2 className="font-headline text-4xl md:text-7xl font-black tracking-tighter leading-[0.9]">
              Curadoria de <span className="text-primary italic">Alto Impacto.</span>
            </h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              ...
              <div className="space-y-8">
                <p className="text-lg text-slate-600 font-medium leading-relaxed">
                  Sua rede social deve ser um reflexo da sua competência técnica. Transformamos feeds em portfólios de autoridade que geram desejo antes mesmo do primeiro contato comercial.
                </p>
      ...
      <section className="py-24 md:py-48 relative">
        <div className="container mx-auto px-6">
          <div className="mb-24 text-center md:text-left max-w-3xl">
            <h3 className="font-headline text-4xl md:text-7xl font-black tracking-tighter leading-none text-white uppercase">Sistemas de <br/>Influência.</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 max-w-6xl mx-auto">
            ...
            <div className="md:col-span-4 p-10 rounded-[3.5rem] bg-primary text-white space-y-8 transition-all duration-700">
               ...
               <div className="space-y-4">
                  <h4 className="font-headline text-2xl md:text-3xl font-black tracking-tighter uppercase leading-none">Estética Premium</h4>
                  <p className="text-base text-white/80">Um feed que comunica profissionalismo absoluto no primeiro segundo de interação visual.</p>
               </div>
            </div>
            ...
            <div className="md:col-span-6 p-10 rounded-[3rem] bg-[#121216] border border-white/5 space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <h4 className="font-bold text-xl tracking-tighter uppercase">Métricas de Valor</h4>
                </div>
                <p className="text-white/40 leading-relaxed text-sm">Análise semanal de engajamento qualificado e conversão vinda de canais sociais.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto space-y-12">
            <h3 className="font-headline text-4xl md:text-8xl font-black tracking-tighter leading-[0.9] text-slate-950">
              Transforme seu <span className="text-primary italic">Posicionamento.</span>
            </h3>
            <p className="text-xl md:text-2xl text-slate-400 font-medium tracking-tight">
              Sua marca não precisa de mais seguidores, ela precisa de autoridade reconhecida pelo mercado.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 pt-8">
              <Button onClick={handleOpenChat} className="h-24 px-16 bg-primary text-white hover:bg-primary/90 rounded-full font-black uppercase tracking-[0.4em] text-[12px] transition-all shadow-2xl shadow-primary/30">
                AUDITAR MEU PERFIL <ArrowRight className="ml-4" />
              </Button>
            </div>
          </div>
        </div>
