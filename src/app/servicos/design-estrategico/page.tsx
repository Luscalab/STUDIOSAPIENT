        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="font-headline text-5xl md:text-8xl font-black text-white tracking-tighter leading-tight mb-8 text-balance">
              Design que <span className="text-white/70 italic">Vende Valor</span> Absoluto
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-40">
            <div className="order-2 lg:order-1 relative">
              <div className="aspect-[4/5] rounded-[4rem] overflow-hidden glass-morphism border border-primary/10 p-12 md:p-16 flex flex-col justify-end space-y-6">
                ...
                <h3 className="font-headline text-4xl font-black text-foreground tracking-tighter">Ativo Estratégico</h3>
            ...
            <div className="order-1 lg:order-2 space-y-12">
              <div>
                <h2 className="font-headline text-4xl md:text-6xl font-black tracking-tighter mb-8">Diferenciação por Precisão Visual</h2>
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="p-8 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md">
                  ...
                  <p className="text-sm text-white/50">Entrega focada em prazos reais de negócio.</p>
                </div>
                <div className="p-8 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md">
                  <Monitor className="h-10 w-10 text-primary mb-4" />
                  <h4 className="font-bold text-xl mb-2">Escalabilidade</h4>
                  <p className="text-sm text-white/50">Ativos prontos para suportar o crescimento da sua marca.</p>
                </div>
              </div>
            </div>
          </div>
