        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 md:gap-32 items-center mb-32 md:mb-64">
            <div className="space-y-12 md:space-y-16">
              <h2 className="font-headline text-5xl md:text-8xl font-black tracking-tighter mb-8 md:mb-12 text-foreground leading-[0.85]">Diferenciação Inquestionável</h2>
            ...
            <div className="bg-[#0c0a1a] rounded-[5rem] p-12 md:p-32 text-white space-y-12 shadow-2xl relative overflow-hidden">
