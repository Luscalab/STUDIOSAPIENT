      ...
      <section className="py-24 md:py-48 bg-white relative">
        <div className="container mx-auto px-6 relative z-10 text-foreground">
          <div className="max-w-5xl mx-auto text-center mb-40">
            <h2 className="font-headline text-5xl md:text-8xl font-black tracking-tighter mb-12 text-foreground leading-[0.85]">Clareza é Autoridade</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-48">
            {[
              ...
              <div key={i} className="bg-secondary p-16 rounded-[4rem] text-center space-y-8 flex flex-col items-center hover:scale-105 transition-all shadow-2xl border border-muted/10 group">
          ...
          <div className="p-16 md:p-32 bg-[#0c0a1a] rounded-[5rem] text-white border border-white/10 shadow-2xl relative overflow-hidden">
