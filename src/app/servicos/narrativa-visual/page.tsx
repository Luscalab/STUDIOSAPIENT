...
import { BrainCircuit, FileText, Sparkles, ArrowRight, Layers, Database, CheckCircle2 } from "lucide-react";
...
export default function NarrativaVisualPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Content Analysis Section - Fundo Branco com Contraste */}
      <section className="py-24 bg-white relative">
        <div className="container mx-auto px-6 relative z-10 text-foreground">
          <div className="max-w-5xl mx-auto text-center mb-32">
            <h2 className="font-headline text-5xl md:text-8xl font-black tracking-tighter mb-10 text-foreground leading-[0.85]">Clareza é a Nova <br/>Moeda de Troca.</h2>
            <p className="text-2xl text-foreground/80 font-medium leading-relaxed tracking-tight text-balance">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 mb-40">
            {[
              ...
              { icon: <FileText className="h-12 w-12" />, title: "Dossiês de Venda", desc: "Apresentações comerciais de luxo desenhadas para fechamentos com CEOs e decisores." },
              ...
              <div key={i} className="bg-secondary/20 p-16 rounded-[4.5rem] text-center space-y-10 flex flex-col items-center hover:bg-white hover:shadow-2xl transition-all duration-500 border border-muted/10 group">
                <div className="w-24 h-24 rounded-[2.5rem] bg-white flex items-center justify-center text-primary border border-muted/10 group-hover:bg-primary group-hover:text-white transition-all shadow-sm">
                  {card.icon}
                </div>
                <h3 className="font-black text-3xl tracking-tighter text-foreground leading-none uppercase">{card.title}</h3>
          ...
          <div className="p-12 md:p-24 bg-[#0c0a1a] rounded-[5rem] text-white border border-white/5 shadow-2xl relative overflow-hidden">
            ...
            <div className="flex flex-col lg:flex-row gap-20 md:gap-32 items-center relative z-10">
              <div className="flex-1 space-y-12">
                <h3 className="font-headline text-5xl md:text-7xl font-black tracking-tighter leading-[0.9]">Onde existe clareza, a venda é a única saída natural.</h3>
