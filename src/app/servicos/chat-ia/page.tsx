        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-40">
            <div className="space-y-12">
              <div>
                <h2 className="font-headline text-4xl md:text-6xl font-black tracking-tighter mb-8 text-white">Atendimento Sem Gargalos</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {[
                  ...
                  { 
                    ...
                    desc: "Sincronização imediata de dados para máxima eficiência em vendas." 
                  }
                ].map((item, i) => (
                  <div key={i} className="p-8 rounded-[2.5rem] bg-white/5 backdrop-blur-3xl border border-white/5 hover:border-primary/20 transition-all duration-500 shadow-2xl">
                    <div className="mb-4">{item.icon}</div>
                    <h3 className="font-bold text-lg mb-2 tracking-tight text-white">{item.title}</h3>
            ...
            <div className="bg-white/5 backdrop-blur-3xl border border-white/10 rounded-[4rem] p-12 md:p-20 text-white space-y-10 relative overflow-hidden shadow-2xl">
               ...
               <ul className="space-y-8 relative z-10">
                 {[
                   ...
                   { t: "Escalabilidade Infinita", d: "Atenda múltiplos clientes simultaneamente com a mesma precisão." }
                 ].map((item, idx) => (
                   <li key={idx} className="flex items-start gap-4">
                     <div className="h-2 w-2 bg-primary rounded-full mt-2 shrink-0" /> 
                     <div>
                       <p className="font-bold text-white text-lg">{item.t}</p>
                       <p className="text-sm text-white/30">{item.d}</p>
                     </div>
                   </li>
                 ))}
               </ul>
          ...
          <div className="max-w-5xl mx-auto py-24 bg-white/5 backdrop-blur-3xl rounded-[4rem] border border-white/5 p-12 md:p-24 text-center space-y-12 shadow-2xl">
            <h3 className="font-headline text-3xl md:text-5xl font-black tracking-tighter text-white">Performance Mensurável</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pt-8">
              <div className="space-y-4">
                ...
                <h4 className="font-bold text-xl text-white">Rapidez Total</h4>
                <p className="text-sm text-white/30">Tempo de resposta zero em qualquer hora do dia ou da noite.</p>
              </div>
              <div className="space-y-4">
                <div className="h-16 w-16 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto text-primary">
                  <BarChart className="h-8 w-8" />
                </div>
                <h4 className="font-bold text-xl text-white">ROI em IA</h4>
                <p className="text-sm text-white/30">Aumento significativo na taxa de conversão de leads frios.</p>
              </div>
              <div className="space-y-4">
                <div className="h-16 w-16 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto text-primary">
                  <Sparkles className="h-8 w-8" />
                </div>
                <h4 className="font-bold text-xl text-white">Filtro de Elite</h4>
                <p className="text-sm text-white/30">Sua equipe comercial foca apenas nos leads qualificados pela IA.</p>
              </div>
            </div>
          </div>
        </div>
