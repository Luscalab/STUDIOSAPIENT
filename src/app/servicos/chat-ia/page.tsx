              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-8">
                   <div className="space-y-2">
                      <p className="text-4xl font-black text-primary tracking-tighter">0.2s</p>
                      <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Tempo de Resposta</p>
                   </div>
                   <div className="space-y-2">
                      <p className="text-4xl font-black text-primary tracking-tighter">99%</p>
                      <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Precisão Técnica</p>
                   </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 md:py-48 relative">
        <div className="container mx-auto px-6">
          <div className="mb-24 text-center md:text-left max-w-3xl">
            <h3 className="font-headline text-4xl md:text-7xl font-black tracking-tighter leading-none text-white uppercase">Sistemas <br/>Cognitivos.</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 max-w-6xl mx-auto">
            <div className="md:col-span-8 p-12 rounded-[3.5rem] bg-white/5 border border-white/10 group hover:bg-white/10 transition-all duration-700 relative overflow-hidden">
               <div className="relative z-10 space-y-8">
                 ...
                 <div className="space-y-4">
                    <h4 className="font-headline text-3xl md:text-5xl font-black tracking-tighter uppercase leading-none">Cérebro Proprietário</h4>
                    <p className="text-lg text-white/50 font-medium max-w-lg">Sua IA é alimentada com seus manuais, processos e know-how exclusivo. Ela fala o que você falaria.</p>
                 </div>
               </div>
            </div>
            ...
            <div className="md:col-span-4 p-10 rounded-[3.5rem] bg-primary text-white space-y-8 transition-all duration-700">
               ...
               <div className="space-y-4">
                  <h4 className="font-headline text-2xl md:text-3xl font-black tracking-tighter uppercase leading-none">WhatsApp API</h4>
                  <p className="text-base text-white/80">Integração oficial via API, permitindo escala massiva sem risco de bloqueios.</p>
               </div>
            </div>
            ...
            <div className="md:col-span-6 p-10 rounded-[3rem] bg-[#121216] border border-white/5 space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <h4 className="font-bold text-xl tracking-tighter uppercase">Qualificação Automática</h4>
                </div>
                <p className="text-white/40 leading-relaxed text-sm">A IA identifica leads prontos para o fechamento e filtra curiosos, otimizando o tempo do seu time comercial.</p>
            </div>

            <div className="md:col-span-6 p-10 rounded-[3rem] bg-[#121216] border border-white/5 space-y-6">
                <div className="flex items-center gap-4">
                  <ShieldCheck className="h-6 w-6 text-primary" />
                  <h4 className="font-bold text-xl tracking-tighter uppercase">Segurança de Dados</h4>
                </div>
                <p className="text-white/40 leading-relaxed text-sm">Protocolos de criptografia e proteção de informações sensíveis do seu negócio e dos seus clientes.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="text-center max-w-4xl mx-auto space-y-12">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 pt-8">
              <Button onClick={handleOpenChat} className="h-24 px-16 bg-primary text-white hover:bg-primary/90 rounded-full font-black uppercase tracking-[0.4em] text-[12px] transition-all shadow-2xl shadow-primary/30">
                ATIVAR MEU ECOSSISTEMA <ArrowRight className="ml-4" />
              </Button>
            </div>
          </div>
        </div>
