...
export function Footer() {
  ...
  return (
    <footer className="py-32 border-t border-muted bg-white overflow-hidden section-flow-top">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-20 lg:gap-32 mb-32 items-start">
            ...
            <div className="flex gap-4">
              {[
                ...
                <Link 
                  ...
                  className="h-12 w-12 rounded-2xl bg-secondary flex items-center justify-center text-primary/40 hover:bg-primary hover:text-white hover:scale-110 transition-all duration-500"
                >
                  {social.icon}
                </Link>
              ))}
