...
export function Navbar() {
  ...
  return (
    <>
      {/* Logo Container - Absolute (Scrolls with page) - Ajustado: Descido 20% no mobile (top-6) e subido 10% no desktop (top-8) */}
      <div className="absolute top-6 md:top-8 left-0 right-0 z-50 pointer-events-none p-2 md:p-3 h-0 overflow-visible">
