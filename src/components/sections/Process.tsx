      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between mb-32 gap-12">
          <div className="max-w-2xl text-center lg:text-left">
            ...
            <h2 className="font-headline text-5xl md:text-8xl font-black tracking-tighter leading-none text-white drop-shadow-2xl">Processo<br />Estratégico</h2>
          </div>
          <p className="text-white/80 text-xl md:text-2xl font-medium max-w-sm leading-relaxed text-center lg:text-left tracking-tight">
            Uma abordagem direta e transparente focada na evolução constante da sua marca.
          </p>
        </div>
