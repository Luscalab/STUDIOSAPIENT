  ...
  return (
    <section id="metodologia" className="py-16 md:py-24 lg:py-32 bg-white text-black relative overflow-hidden rounded-[3rem] md:rounded-[6rem] mx-4 my-6 shadow-xl">
      <div className="container mx-auto px-6 relative z-10">
        <div className="mb-12 lg:mb-24 text-center md:text-left max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-[1440px] mx-auto items-stretch">
          {steps.map((step, idx) => (
            <div key={idx} className="group relative p-8 md:p-10 rounded-[2.5rem] bg-secondary/30 border border-muted/5 transition-all duration-700 hover:bg-white hover:shadow-2xl flex flex-col justify-between h-full overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-black/60 text-sm md:text-base leading-relaxed font-medium tracking-tight mb-8">
                  {step.desc}
                </p>
              </div>
              ...
              <span className="text-[5rem] md:text-[8rem] font-black text-black/[0.03] absolute -bottom-4 -right-2 md:-bottom-6 md:-right-3 select-none group-hover:text-primary/[0.05] transition-all duration-700 leading-none pointer-events-none">
                0{idx + 1}
              </span>
            </div>
          ))}
