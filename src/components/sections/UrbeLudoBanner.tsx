          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1 mb-0.5">
              ...
              <span className="text-[6px] md:text-[7px] font-black text-white/30 uppercase tracking-[0.3em] md:tracking-[0.4em]">
                {t('urbeludo_banner.badge')}
              </span>
            </div>
            
            <h4 className="font-headline text-white font-bold text-[11px] md:text-sm tracking-tight leading-tight mb-1">
              {t('urbeludo_banner.title')} <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-cyan-400 italic">{t('urbeludo_banner.title_italic')}</span>
            </h4>
            ...
            >
              {t('urbeludo_banner.explore')} <ArrowRight className="h-2 w-2 md:h-2.5 md:w-2.5 group-hover/link:translate-x-1 transition-transform text-primary" />
            </Link>
          </div>
