...
export function Portfolio() {
  ...
  return (
    <section id="portfolio" className="py-32 md:py-64 bg-white relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_0%_0%,rgba(139,92,246,0.05),transparent_50%)] pointer-events-none" />
      
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto text-center mb-40">
           <div className="flex items-center justify-center gap-4 mb-10">
               <Trophy className="text-primary h-6 w-6" />
               <Badge className="bg-primary/5 text-primary border-primary/10 px-12 py-4 text-[10px] font-black uppercase tracking-[0.6em] rounded-none">Exibição de Impacto</Badge>
            </div>
          <h2 className="font-display text-5xl md:text-[11rem] font-black tracking-tighter leading-[0.8] mb-12">
            Peça de<br /><span className="text-primary italic">Exposição.</span>
          </h2>
          <p className="text-muted-foreground/50 text-2xl md:text-4xl font-medium max-w-3xl mx-auto leading-tight tracking-tight">
        ...
        <div className="max-w-[95rem] mx-auto">
          <Link 
            href={behanceUrl}
            target="_blank"
            className="group relative block aspect-video md:aspect-[24/10] rounded-[5rem] overflow-hidden bg-secondary shadow-4xl transition-all duration-1000 hover:-translate-y-10"
          >
            <Image 
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent opacity-80 group-hover:opacity-100 transition-opacity duration-1000" />
            ...
            <div className="absolute inset-0 p-16 md:p-32 flex flex-col justify-end">
              <div className="max-w-5xl space-y-12">
                <div className="flex items-center gap-10">
                  <div className="h-28 w-28 rounded-[3rem] bg-primary/90 backdrop-blur-2xl flex items-center justify-center text-white shadow-[0_30px_60px_rgba(var(--primary),0.5)] border border-white/20">
        ...
        <div className="mt-48 text-center">
          <Link 
            href={behanceUrl} 
            target="_blank" 
            className="inline-flex items-center gap-12 p-14 rounded-none bg-[#0a0a0c] text-white hover:bg-primary transition-all duration-1000 group shadow-[0_40px_100px_rgba(0,0,0,0.2)]"
          >
