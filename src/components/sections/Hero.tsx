...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-40 pb-20 md:pt-56 md:pb-24 max-w-full px-4">
      ...
      <div className="container relative z-10 mx-auto max-w-6xl">
        <div className="text-center">
          ...
          <h1 className="font-headline text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-[-0.04em] mb-10 animate-fade-in-up [animation-delay:200ms] text-white leading-[1.1] text-balance drop-shadow-[0_15px_40px_rgba(0,0,0,0.5)]">
            Dominamos a Arte da<br />
            <span className="text-white tracking-[-0.01em] italic font-semibold opacity-90">Autoridade Digital.</span>
          </h1>
          ...
          <p className="max-w-xl md:max-w-2xl mx-auto text-base md:text-lg lg:text-xl text-white/80 mb-14 animate-fade-in-up [animation-delay:400ms] leading-relaxed font-medium tracking-tight text-balance">
            Elevamos sua presença através de ecossistemas visuais de alta conversão, unindo design de prestígio e engenharia de performance para marcas que buscam o topo.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 animate-fade-in-up [animation-delay:600ms]">
            ...
            <Link href={behanceUrl} target="_blank" className="w-full sm:w-auto">
              <Button variant="outline" className="w-full sm:w-auto h-16 md:h-20 px-12 md:px-16 text-[11px] md:text-[12px] font-black border-white/40 hover:bg-white/20 transition-all rounded-full group uppercase tracking-[0.25em] bg-white/10 backdrop-blur-md text-white shadow-[0_0_40px_rgba(255,255,255,0.1)]">
                Projetos de Elite <ArrowRight className="ml-3 h-6 w-6 group-hover:translate-x-1 transition-transform" />
              </Button>
            </Link>
          </div>
        </div>
