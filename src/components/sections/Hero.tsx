...
export function Hero() {
  ...
  return (
    <section className="relative pt-24 pb-20 md:pt-40 md:pb-28 lg:pt-56 lg:pb-32 overflow-hidden mx-4 rounded-[3rem] md:rounded-[6rem] mt-4 mb-10">
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] lg:w-[800px] lg:h-[800px] bg-primary/5 blur-[150px] rounded-full" />
        <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-5" />
      </div>

      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-[1200px] mx-auto text-center">
          <h1 className="font-headline text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-white tracking-tighter leading-[0.95] mb-10 py-2">
          ...
          <p className="text-base md:text-lg lg:text-xl text-white/50 font-medium max-w-2xl mx-auto leading-relaxed tracking-tight text-balance mb-16">
