    ...
    <section className="relative min-h-[40vh] md:min-h-[50vh] flex items-center justify-center overflow-hidden pt-8 pb-10">
      ...
      <div className="container relative z-10 mx-auto px-6">
        <div className="max-w-[1100px] mx-auto text-center">
          ...
          <h1 className="font-headline text-4xl sm:text-5xl md:text-6xl lg:text-[5.5rem] font-extrabold tracking-[-0.04em] mb-4 animate-fade-in-up [animation-delay:200ms] text-white leading-[0.85] text-balance drop-shadow-[0_15px_30px_rgba(0,0,0,0.3)]">
          ...
          <p className="max-w-2xl mx-auto text-sm md:text-lg text-white/80 mb-6 animate-fade-in-up [animation-delay:400ms] leading-relaxed font-medium tracking-tight px-4 text-balance">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up [animation-delay:600ms]">
            <Button 
              ...
              className="w-full sm:w-auto h-12 md:h-14 px-8 md:px-10 text-[10px] font-bold bg-white text-primary hover:bg-white/90 shadow-[0_20px_50px_rgba(255,255,255,0.2)] transition-all hover:scale-105 active:scale-95 rounded-full uppercase tracking-[0.2em] border-none"
            >
              Iniciar Diagnóstico
            </Button>
            <Link href={behanceUrl} target="_blank" className="w-full sm:w-auto">
              <Button variant="outline" className="w-full sm:w-auto h-12 md:h-14 px-8 md:px-10 text-[10px] font-bold border-white/30 hover:bg-white/10 transition-all rounded-full group uppercase tracking-[0.2em] bg-white/5 backdrop-blur-md text-white">
