...
export function Hero() {
  ...
  return (
    <section className="relative pt-32 pb-24 md:pt-48 md:pb-32 overflow-hidden">
      {/* Background com Mesh de Luz Roxo Sapient e Textura Técnica */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-[1400px] mx-auto text-center">
          <h1 className="font-headline text-5xl md:text-8xl lg:text-9xl font-black text-white tracking-tighter leading-[0.95] mb-12 animate-fade-in-up py-4">
            Criatividade que gera valor. <br />
          ...
          <p className="text-lg md:text-2xl text-white/50 font-medium max-w-4xl mx-auto leading-relaxed tracking-tight text-balance mb-20 animate-fade-in-up [animation-delay:200ms]">
            Apoiamos o crescimento do seu negócio através de um design que comunica com clareza e estratégias que trazem resultados reais. <span className="text-white font-bold tracking-tight">Sem termos complexos, apenas parcerias verdadeiras para o seu sucesso.</span>
          </p>
